...
// GetUsersBySlug provides a mock function with given fields: ctx, slug
func (_m *SegmentRepository) GetUsersBySlug(ctx context.Context, slug string) ([]user.User, error) {
	ret := _m.Called(ctx, slug)
